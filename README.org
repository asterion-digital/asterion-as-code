...
Asterion infra development environments can also be deployed on a Raspberry Pi. Use the following [[https://aws.amazon.com/console/][RPI guide]] to setup this infrastructure quickly and easily.
