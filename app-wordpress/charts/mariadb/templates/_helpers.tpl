...
Usage:
{{ include "mariadb.tplvalues.render" ( dict "value" .Values.path.to.the.Value "context" $) }}
*/}}
{{- define "mariadb.tplvalues.render" -}}
...
{{ include "mariadb.storage.class" ( dict "persistence" .Values.path.to.the.persistence "global" $) }}
*/}}
{{- define "mariadb.storage.class" -}}
